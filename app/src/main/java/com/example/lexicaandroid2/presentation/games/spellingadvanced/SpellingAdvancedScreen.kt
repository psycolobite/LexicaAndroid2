            ...
            when {
                ...
                uiState.gameOver -> {
                    Column(
                        ...
                        Text("Spelling avancé terminé", fontSize = 28.sp, fontWeight = FontWeight.Bold)
                        Text(
                        ...
                        Row(
                            ...
                            Box(
                                modifier = Modifier
                                    ...
                                    .clickable(enabled = !uiState.isSpeaking) {
                                        viewModel.playWord(card?.recto)
                                    },
