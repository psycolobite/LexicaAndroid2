    ...
    val googleLauncher = rememberLauncherForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        if (result.resultCode != android.app.Activity.RESULT_OK) {
            ...
            GoogleSignInHelper.extractIdToken(result.data)
                .onSuccess(viewModel::loginWithGoogleIdToken)
                .onFailure {
        ...
        Box(
            ...
            ElevatedCard(
                ...
                Column(
                    ...
                    Text(
                        text = "Retrouver les mots, la progression et la synchronisation sur n'importe quel appareil.",
                    ...
                    Text(
                        text = "Si aucun compte n'existe encore, Google le créera automatiquement.",
                        style = MaterialTheme.typography.bodySmall,
                        textAlign = TextAlign.Center,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
