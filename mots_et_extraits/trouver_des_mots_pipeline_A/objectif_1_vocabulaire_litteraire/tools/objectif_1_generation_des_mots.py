...
Ce script génère les mots et leurs caractéristique pour la variable "pöle sémantique". Il croise les methodes de classification wiktionnaire et embenddings :
discover_literary_words_max.py
 : Scorage V3 des catégories soutenues/littéraires/poétiques/archaïques du Wiktionnaire combiné à Lexique383.
 et
discover_literary_embeddings_max.py
 : Similarité cosinus des embeddings via le modèle OrdalieTech/solon-embeddings-large-0.1 par rapport au centroïde littéraire.
"""
